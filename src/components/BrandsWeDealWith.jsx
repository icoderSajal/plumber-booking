  ...
  return (
    <section className="py-16 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <p className="text-center text-gray-600 mt-3 max-w-xl mx-auto">
          We work with reliable sanitary, bathroom and plumbing brands trusted by professionals.
        </p>
          ...
          <div className="flex w-max animate-scroll gap-12">
            ...
            {[...brands, ...brands].map((brand, index) => (
              <div key={index} className="flex flex-col items-center min-w-[140px]">
                <div className="w-32 h-32 rounded-2xl bg-white shadow-md flex items-center justify-center hover:shadow-xl transition">
                  <img
                    src={brand.logo}
                    alt={brand.name}
                    className="w-20 h-20 object-contain"
